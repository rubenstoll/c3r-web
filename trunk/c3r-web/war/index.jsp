...
<form name="localeForm" action="jsp/checkrules.jsp" method="post">
</p>
...
</select> <input type="submit" name="Submit" value="Get Date"></form>

<c:if test="${selectedFlag}">
	<jsp:setProperty name="locales" property="selectedLocaleString"
		value="${selectedLocaleString}" />
	<jsp:useBean id="date" class="org.unitedstollutions.c3r.utils.MyDate" />
