...
package org.unitedstollutions.c3r.messages;

import java.util.*;

public class C3RWebMessages extends ListResourceBundle {
	static final Object[][] contents = {
			{ "QueryStart", "starting query ..." },
			{ "ServerError",
			...
			{ "ConfirmRemove",
					"You just removed \"{0}\" from your shopping cart" },
			{
					"CartItemCount",
			...
			{ "BookCatalog",
					"Add books from the catalog to your shopping cart." },
			{ "ShoppingCart",
					"This page lists the books in your shopping cart." },
